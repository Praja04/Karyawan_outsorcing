...
<script>
    $(function() {
        ...
        function fetchEmployees() {
            $.ajax({
                ...
                success: function(res) {
                    employeesList = res;
                    filteredEmployees = res; // default: semua data
                    renderTable();
                },
                error: function() {
        ...
        $('.pagination-next').click(function(e) {
            e.preventDefault();
            const totalPages = Math.ceil((isSearching ? filteredEmployees.length : employeesList.length) / itemsPerPage);
        ...
        $('#uploadWaForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{url('/admin/employee/template-wa')}}",
                method: 'POST',
                data: formData,
                contentType: false,
                processData: false,
