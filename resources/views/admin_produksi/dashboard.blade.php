            ...
            <div class="col">
                <div class="h-100">
                    ...
                    <div class="position-relative my-4 text-center">
                        <hr class="border-2 border-success opacity-50">
                        <span class="position-absolute top-50 start-50 translate-middle px-3 bg-body fw-semibold text-success">
                            <i class="bx bx-calendar-event me-1"></i> Planning & Plotting
                        </span>
                    </div>
                    <div class="row">
                        @foreach (['A', 'B', 'C', 'N'] as $group)
                    ...
                    <div class="position-relative my-4 text-center">
                        ...
                        <span class="position-absolute top-50 start-50 translate-middle px-3 bg-body fw-semibold text-primary">
                            <i class="bx bx-bar-chart-alt-2 me-1"></i> Summary Kehadiran Harian
                        </span>
                        ...
                        <div class="col-xl-6 mb-4">
                            <div class="card border-success">
                                <div class="card-header bg-success text-white d-flex align-items-center">
                                    <h4 class="card-title mb-0 flex-grow-1">Summary Kehadiran Harian - Group {{ $group }}</h4>
